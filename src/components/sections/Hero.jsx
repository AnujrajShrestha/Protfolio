  ...
  return (
    <section ref={rootRef} id="top" className="relative flex min-h-[92vh] flex-col justify-center pb-16 pt-40">
      ...
      <p className="hero-tag mb-5 text-sm text-muted">
        $ ssh Anuj.dev<span className="ml-1 inline-block h-3.5 w-2 animate-blink bg-phosphor align-middle" />
      </p>
      ...
      <div className="hero-cta mt-9 flex flex-wrap gap-4">
        ...
        <MagneticButton
          href="https://github.com/AnujrajShrestha"
          target="_blank"
          rel="noopener"
        ...
        >
          git clone github.com/AnujrajShrestha
        </MagneticButton>
      </div>
